...
class HnrPlaces extends StatefulWidget {
  const HnrPlaces({super.key});

  @override
  State<HnrPlaces> createState() => _HnrPlacesState();
}

class _HnrPlacesState extends State<HnrPlaces> {
  ...
  final List<Map<String, String>> locations = [
    ...
    {
      'image': 'assets/images/honnavar.jpg',
      'name': 'Backwater',
