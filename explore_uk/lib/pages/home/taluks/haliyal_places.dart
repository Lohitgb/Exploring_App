...
class HaliyalPlaces extends StatefulWidget {
  const HaliyalPlaces({super.key});

  @override
  State<HaliyalPlaces> createState() => _HaliyalPlacesState();
}

class _HaliyalPlacesState extends State<HaliyalPlaces> {
