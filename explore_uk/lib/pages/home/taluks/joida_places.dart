...
class JoidPlaces extends StatefulWidget {
  const JoidPlaces({super.key});

  @override
  State<JoidPlaces> createState() => _JoidPlacesState();
}

class _JoidPlacesState extends State<JoidPlaces> {
