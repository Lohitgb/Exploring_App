import 'package:explore_uk/pages/auth/signin.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ProfileMenu(
              text: 'My Account',
              icon: 'assets/images/forest Icon.svg',
              press: () => {},
            ),
            ProfileMenu(
              text: 'Notifications',
          ...
          child: Row(
            children: [
              SvgPicture.asset(
                icon,
                colorFilter:
                    ColorFilter.mode(Color(0xFFFF7643), BlendMode.srcIn),
                width: 22,
              ),
              SizedBox(
                width: 20,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          CircleAvatar(
            backgroundImage: AssetImage('assets/images/honnavar.jpg'),
          ),
          Positioned(
            right: -16,
            bottom: 0,
